    ...
    <div>
      ...
      <section className="body-font min-h-screen">
        ...
        <div className="mx-auto h-screen flex md:flex-row flex-col px-5 items-center justify-center bg-inpal-primary">
          <div className="container lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-start text-left text-white">
            ...
            <p className="mb-8 leading-relaxed sm:w-1/2 sm:text-xl">
