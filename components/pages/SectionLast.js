...
export default function SectionLast() {
  return (
    <section className="section06 relative container h-screen mx-auto flex px-5 py-24 items-center justify-center flex-col z-40">
      <img src="arms.svg" alt="arms" className="w-3/4 mb-10" />
      <div className="text-center lg:w-2/3 w-full lx:mb-28 mb-0">
        ...
        <Link href="/contact">
          <button className=" text-white box-border border-white border-2 py-2 px-8 focus:outline-none hover:bg-secondary-color hover:border-secondary-color rounded text-lg mt-10 sm:mt-0 duration-300">
            연락하기
          </button>
        </Link>
      </div>
