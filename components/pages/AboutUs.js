  ...
  return (
    <section className=" body-font min-h-screen">
      <div className="container mx-auto h-screen flex px-5 py-24 md:flex-row flex-col items-center justify-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-left">
          ...
          <h1 className="title-font sm:text-4xl text-2xl mb-8 font-medium text-gray-900">
            Service becomes
            <br className="hidden lg:inline-block" />A through technology and
            innovation.
          </h1>
        ...
        <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
          <LogoGray className="md:w-3/5 md:mb-0 mb-20 md:block hidden" />
        </div>
      </div>
    </section>
  );
